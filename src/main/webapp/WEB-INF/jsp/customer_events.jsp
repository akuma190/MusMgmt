                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <a href="customerEventPaintings/${eventList.eventid}" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                </div>

                                <h2>${eventList.eventname}</h2>

                                <div class="product-carousel-price">
                                    <ins>${eventList.eventtype} Painter event</ins>
                                </div>
                            </div>
                        </c:forEach>
                    </div>
