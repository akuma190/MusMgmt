...
<div class="single-product-area">
    ...
    <div class="container">
        <div class="row">
            <c:forEach items="${paintingList}" var="paintingList">
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <img src="../img/product-2.jpg" alt="">
                        </div>
                        <h2>${paintingList.artworkname}</h2>
                        <div class="product-carousel-price">
                            <ins>${paintingList.price}</ins>
                        </div>

                        <div class="product-option-shop">
                            <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="../customerPaintingBuy/${paintingList.artworkid}">Buy</a>
                        </div>
                    </div>
                </div>
            </c:forEach>
