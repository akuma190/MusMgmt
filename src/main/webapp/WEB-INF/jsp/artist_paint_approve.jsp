            ...
            <div class="col-md-12">
                <table class="shop_table" id="tblCustomers">
                    ...
                    <tr>
                        ...
                        <th class="product-total">Original Price</th>
                    ...
                    <c:forEach items="${hash}" var="hash">
                        <tr>
                            ...
                            <td><c:out value="${hash.key.artworkname}" /></td>
                            <td><c:out value="${session.username}" /></td>
                            <td><c:out value="${hash.key.creationdate}" /></td>
                            <td><c:out value="${hash.key.price}" /></td>
                            <td><c:out value="${hash.value.quotedprice}" /></td>
                            <td>
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="artistFinalApprove/${hash.key.artworkid}" type="button" style="width:100px;height:45px;"class="btn btn-primary" >Approve</a>
                                    </div>
                                    <div class="col-md-6">
                                        <form action="deleteArtistArtwork" method="post">
                                            <input type="hidden" id="artId" name="artId" value="${hash.key.artworkid}">
