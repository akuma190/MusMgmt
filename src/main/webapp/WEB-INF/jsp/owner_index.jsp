        ...
        <div class="row">
            <div class="col-md-12">
                <div class="latest-product">
                    <h2 class="section-title">Latest Sold Paintings</h2>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <a href="ownerPaintingDetails/${hash.value.artworkid}" class="view-details-link" target="_blank"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                </div>

                                <h2>${hash.value.artworkname}</h2>

                                <div class="product-carousel-price">
                                    <ins>MRP : $${hash.value.price}</ins> <ins>SOLD : $${hash.key.soldamount}</ins>
                                </div>
                            </div>
                        </c:forEach>
