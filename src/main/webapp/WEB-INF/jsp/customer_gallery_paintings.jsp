            ...
            <c:forEach items="${artList}" var="artList">
                <div class="col-md-3 col-sm-6">
                    <div class="single-shop-product">
                        ...
                        <h2>${artList.artworkname}</h2>
                        <div class="product-carousel-price">
                            <ins>$${artList.price}</ins>
                        </div>

                        <div class="product-option-shop">
                            <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="../customerPaintingBuy/${artList.artworkid}">Buy</a>
                        </div>
                    </div>
                </div>
            </c:forEach>
